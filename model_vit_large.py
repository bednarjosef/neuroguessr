...
class GeoguessrViTLarge(nn.Module):
    def __init__(self, CONFIG, model_name='vit_large_patch14_clip_336.laion2b_ft_in12k_in1k', pretrained=True):
        super().__init__()
        ...
        self.head = nn.Sequential(
            ...
            # Output Layer
            nn.Linear(hidden_dim, CONFIG['clusters'])
        )
    ...
    def forward(self, x):
        ...
        logits_cluster = self.head(pooled_features)
